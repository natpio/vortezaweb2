...
# 2. ZAAWANSOWANY CSS (Modularne Fundamenty & Czytelność)
st.markdown("""
    <style>
    /* Globalne tło: Marmurowy gradient przechodzący w grafitową czerń, bez powtarzalnych wzorów */
    .stApp {
    ...
    /* Panele szklane z czytelnym tłem i złotą ramką */
    .glass-panel {
    ...
    /* Sekcja Hero - dodanie czytelności */
    .hero-box {
        padding: 6rem 3rem;
        text-align: center;
    ...
    .hero-title span {
        color: #bda886; /* Złoty akcent technologiczny */
    }
    .hero-subtitle {
        color: #5a6a7e;
        font-size: 1.25rem;
    ...
    /* Przyciski z czytelnością na ciemnym tle */
    .btn-primary {
    ...
    /* Nagłówki sekcji (czytelność na ciemnym tle) */
    .section-header-dark {
        text-align: center;
        color: #0b213f;
        font-size: 2.5rem;
...
# 3. HERO SECTION (Zwarte tagi HTML zapobiegające błędom)
...
# Zmieniono kolor nagłówka na jasny, aby był czytelny na ciemnej stronie tła.
st.markdown("<h2 id='architektura' class='section-header-light'>Trzy Filary Vorteza</h2>", unsafe_allow_html=True)

col1, col2, col3 = st.columns(3)

# Wyczyszczone kody HTML kart (żadnych komentarzy ani pustych linii)
...
# 6. STOPKA
# Dodano czytelny panel kontaktowy, aby tło nie przeszkadzało.
